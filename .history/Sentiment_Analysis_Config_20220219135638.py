...
@Version: 1.0
@LastEditors: HsuDan
@LastEditTime: 2022-02-19 13:56:39
@Description: file content
@FilePath: /Sentiment/Sentiment-Analysis-Chinese-pytorch/Sentiment_Analysis_Config.py
''' 
class Config():
    ...
    train_path = './word2vec/train.txt'
    val_path = './word2vec/validation.txt'
    test_path = './word2vec/test.txt'
    pre_path ='./word2vec/pre.txt'
