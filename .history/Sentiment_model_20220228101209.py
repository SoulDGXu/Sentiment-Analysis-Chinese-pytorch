...
class LSTMModel(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        - pretrained_weight: file, the pretrained embeddding weight file
        - update_w2v: bool, whether to update word2vec weight
        - hidden_dim: int, the hidden
        num_layers,
        drop_keep_prob,
        n_class,
        bidirectional,
    ...
    def forward(self, inputs):
        ...
        )  # [75,32,50],[seq_len, batch, embed_dim]
